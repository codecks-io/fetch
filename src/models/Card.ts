...
export const cardDesc = makeModel({
  ...
  relations: {
    ...
    inDeps: relation("card", {type: "hasMany", fkAsArray: true}),
    outDeps: relation("card", {type: "hasMany", fkAsArray: true}),
    cardReferences: relation("card", {type: "hasMany", fkAsArray: true}),
